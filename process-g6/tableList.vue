<template>
    <div class="app-container">
        <div class="base-row">
          ...
          <search-form v-show="searchToggle" ref="searchForm" :searchFormData="configData"></search-form>
        </div>
        <div class="base-row">
            <div class="row-botton clearfix">
              <div class="row-title">
          ...
          <basic-table v-show="tableToggle" ref="basicTable" :height="getDefaultHeight" :tableOption="configData" :pagenation="true" :rowNum="true" >
            <el-table-column slot="firstColumn" label="节点名称" align="center" width="250"> 
              <template slot-scope="scope">
                <a href="javaScipt:void 0;" @click="getNode(scope.row)">{{scope.row.node_name}}</a>
              </template>
            </el-table-column>
            <el-table-column slot="optionColumn" label="操作" fixed="right" align="center" width="250"> 
              <template slot-scope="scope">
